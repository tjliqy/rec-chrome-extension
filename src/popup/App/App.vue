<template>
  <div class="main_app">
    <div class="panel-background">
      ...
      <div class="user-info">
        <b style="float: left">当前用户：{{ activeUser.name }}</b>
        <b style="float: right ">历史浏览量：{{history.length}}</b>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      activeUser: {
        ...
        age: 30,
        location: "LA",
        history: ['6993568771491299878', '7005501448200913445', '7005398379866063396', '6998537592664900108', '6988813649813160455']
      },
      category: "Sport",
      historyNewsList:[],
      categoryCount: {},
  ...
  methods: {
    loadUserId() {
      ...
      vue_this.activeUser.name = win.data;
